    ...
    @foreach ($children as $child)
        <div class="d-flex bordered ">
            ...
            <li class="d-flex justify-content-between w-100 p-2 shadow-sm my-2 rounded border">
                ...
                <div class="d-flex">
                    <!-- Nút View -->
                    <a wire:navigate href="{{ route('category.show', $child->id) }}" class="mx-2 text-secondary"><i
                            class="fa-solid fa-eye"></i></a>
                    {{-- Sửa --}}
                    <a wire:navigate href="{{ route('category.edit', $child->id) }}" class="mx-2 text-success"><i
